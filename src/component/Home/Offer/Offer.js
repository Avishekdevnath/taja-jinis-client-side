...
const Offer = () => {
    return (
       <div>
            ...
            <div className="shadow-lg shadow-pink-300 card w-96 h-96 bg-[#63cdda] shadow-lg my-10 ">
            ...
            <div className="shadow-lg shadow-blue-300  card w-96 h-96 bg-[#feca57] shadow-lg my-10">
                <div className="card-body ">
                    <h2 className="card-title">৳১২০০</h2>
                    <h2 className="card-title">ফলের বিশেষ অফার</h2>
                    <p className="card-text">For most corporate business events </p>
            ...
            <div className="shadow-lg shadow-orange-300  card w-96 h-96 bg-[#f78fb3] shadow-lg my-10">
                <div className="card-body">
